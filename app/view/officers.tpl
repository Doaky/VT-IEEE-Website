...
<main class="officers-page">
	...
	<figure class="officer">
		<img class="officer-picture" src="<?= BASE_URL ?>/app/public/img/officer_pictures/avery_neff.jpg" alt="President - Avery Neff"/>
		<figcaption>
	...
	<figure class="officer">
		...
		<figcaption>
			...
			<h4 class="officer-position">Academic Development</h4>
			<h4 class="officer-year">Electrical Engineering '20</h4>
